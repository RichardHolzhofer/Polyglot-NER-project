...
Extract Named Entities from <b>Hungarian</b> and <b>German</b> text using a fine-tuned Transformer model.
</p>
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if not results:
                        ...
                        st.dataframe(df[['word', 'entity_group', 'score']], hide_index=True, use_container_width=True)
                else:
...
# --- FOOTER ---
st.markdown("<br><hr><center><small>Polyglot NER Project • Built with FastAPI & Streamlit</small></center>", unsafe_allow_html=True)
